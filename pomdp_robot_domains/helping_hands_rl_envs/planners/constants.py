...
from helping_hands_rl_envs.planners.close_loop_pomdp_block_stacking_planner import CloseLoopPomdpBlockStackingPlanner
...
PLANNERS = {
  ...
  'close_loop_pomdp_block_stacking':CloseLoopPomdpBlockStackingPlanner,
  ...
  'close_loop_pomdp_drawer_opening':CloseLoopPomdpDrawerOpeningPlanner,
  'close_loop_pomdp_drawer_opening_hard':CloseLoopPomdpDrawerOpeningHardPlanner,
  ...
  'close_loop_pomdp_block_pushing':CloseLoopPomdpBlockPushingPlanner,
