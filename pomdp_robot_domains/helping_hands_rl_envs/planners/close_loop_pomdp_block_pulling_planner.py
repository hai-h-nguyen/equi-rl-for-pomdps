...
class CloseLoopPomdpBlockPullingPlanner(CloseLoopPlanner):
  ...
  def setNewTarget(self, target_obj_idx):
    obj1_pos = self.env.objects[target_obj_idx].getPosition()
    obj2_pos = self.env.objects[1-target_obj_idx].getPosition()
